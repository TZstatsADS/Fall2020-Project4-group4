...
In the stratification method, we are trying to achieve groups where propensity scores hold approximately. For choosing number of stata, $K$, five ($5$) was advocated by Rosenbaum and Rubin (1984). However, in our case, choosing $K = 5$ will lead to empty stratum for both high and low dimensional data.
